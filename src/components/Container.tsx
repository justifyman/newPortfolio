  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://www.justifydev.codes${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.justifydev.codes${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="JustifyDev" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="JustifyDev" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">justify</span>
        </Link>
